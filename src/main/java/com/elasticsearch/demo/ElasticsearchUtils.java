...
public class ElasticsearchUtils {
	...
	public ElasticsearchUtils(String clusterName, String ipAddress) {
		...
		client = new TransportClient(settings).addTransportAddress(new InetSocketTransportAddress(new InetSocketAddress("127.0.0.1", 9300)));// 此处端口号为9300
	}
	 ...
	 * @return
	 */
	public SearchResponse searcher(String indexName, String typeName, QueryBuilder queryBuilder) {
	 ...
	 *            json数据
	 */
	public void updateIndex(String indexName, String typeName, String id, String jsonData) {
