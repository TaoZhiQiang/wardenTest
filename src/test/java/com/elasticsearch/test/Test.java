...
import com.elasticsearch.demo.ElasticsearchUtils;
...
public class Test {
    public static void main(String[] args) {
        ...
        String id = "1";
        String jsonData = "{" + "\"name\":\"xiyan\","
                + "\"birth\":\"2017-11-09\"," + "\"email\":\"zhi55215221.com\""
                + "}";//json数据
...
//        //2.执行查询
//        //(1)创建查询条件
//        QueryBuilder queryBuilder = QueryBuilders.termQuery("name", "xiyan");//搜索name为kimchy的数据
//        //(2)执行查询
...
//
//        //3.更新数据
//        jsonData = "{" + "\"name\":\"jack\"," + "\"birth\":\"2017-11-10\","
